#! /usr/bin/env python
"""This is an example of how to call the search method on the IncidentDao obj"""
# ---------------------- #
...
param_dict = {"query": "SELECT incident_number, started_on, repaired_on, resolved_on WHERE severity = 1 PAGE 1, 250"}
if api.send_request('IncidentDao', 'search', param_dict) == True:
